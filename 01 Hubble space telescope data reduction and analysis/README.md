...
This project is ongoing, working toward a complete reduction pipeline: from raw FITS input through calibration, source detection,aperture photometry, and catalog production.
